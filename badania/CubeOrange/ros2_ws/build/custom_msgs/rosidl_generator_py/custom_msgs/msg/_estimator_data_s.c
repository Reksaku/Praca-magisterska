...
bool custom_msgs__msg__estimator_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // possition
    ...
    if (!custom_msgs__msg__possition_data__convert_from_py(field, &ros_message->possition)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * custom_msgs__msg__estimator_data__convert_to_py(void * raw_ros_message)
{
  ...
  {  // possition
    PyObject * field = NULL;
    field = custom_msgs__msg__possition_data__convert_to_py(&ros_message->possition);
    if (!field) {
      return NULL;
    }
    {
