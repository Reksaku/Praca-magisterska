...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EstimatorData_message_member_array[2] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<custom_msgs::msg::PossitionData>(),  // members of sub message
    false,  // is key
    false,  // is array
    0,  // array size
    false,  // is upper bound
