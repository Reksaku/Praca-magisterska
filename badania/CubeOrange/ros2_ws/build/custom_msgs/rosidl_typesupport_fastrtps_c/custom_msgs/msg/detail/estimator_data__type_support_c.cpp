...
#include "custom_msgs/msg/detail/possition_data__functions.h"  // possition

// forward declare type support functions

bool cdr_serialize_custom_msgs__msg__PossitionData(
  const custom_msgs__msg__PossitionData * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_custom_msgs__msg__PossitionData(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs__msg__PossitionData * ros_message);
...
bool cdr_serialize_key_custom_msgs__msg__PossitionData(
  const custom_msgs__msg__PossitionData * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_custom_msgs__msg__PossitionData(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_custom_msgs__msg__PossitionData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr_serialize_custom_msgs__msg__PossitionData(
  ...
  custom_msgs__msg__EstimatorData * ros_message)
{
  ...
  // Field name: possition
  {
    cdr_deserialize_custom_msgs__msg__PossitionData(cdr, &ros_message->possition);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: possition
  current_alignment += get_serialized_size_custom_msgs__msg__PossitionData(
  ...
  size_t current_alignment)
{
  ...
  // Field name: possition
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_custom_msgs__msg__PossitionData(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: possition
  {
    cdr_serialize_key_custom_msgs__msg__PossitionData(
      &ros_message->possition, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: possition
  current_alignment += get_serialized_size_key_custom_msgs__msg__PossitionData(
    &(ros_message->possition), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: possition
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_custom_msgs__msg__PossitionData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
